...
status: active
tags: [python, fundamentals, syntax, "data-structures", functions]
keywords: [Python, fundamentos, variables, tipos, funciones, estructuras de datos, bucles, condicionales]
