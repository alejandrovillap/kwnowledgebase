...
Python es un lenguaje de programación interpretado y de tipado dinámico, lo que significa que no es necesario declarar el tipo de las variables. Es conocido por su sintaxis clara y legible, y cuenta con una amplia biblioteca de funciones integradas que facilitan operaciones comunes como entrada/salida, manipulación de texto, operaciones numéricas y manejo de estructuras de datos.
...
str(100)               # "100"
bool(0)                # False
bool(1), bool("x")     # True  (cualquier valor no vacío)
list("abc")            # ['a', 'b', 'c']
```
...
round(3.7)          # 4      redondeo estándar
round(3.14159, 2)   # 3.14   redondeo con decimales
min(3, 1, 4, 1, 5)  # 1
max(3, 1, 4, 1, 5)  # 5
sum([1, 2, 3])      # 6
pow(2, 10)          # 1024   equivalente a 2**10
