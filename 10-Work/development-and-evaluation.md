...
technology: "gen-ai"
status: active
tags: ["ml-evaluation", "model-selection", "experiment-tracking", "baseline-models", "validation-datasets", "performance-metrics"]
keywords: [ML evaluation, baseline, model selection, experiment tracking, reproducibility, lineage, business justification, KPIs, probabilistic, validation dataset]
