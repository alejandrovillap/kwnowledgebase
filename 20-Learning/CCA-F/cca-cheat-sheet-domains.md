---
title: CCA Cheat Sheet — By Domain
date: 2026-04-12
type: reference
technology: "gen-ai"
status: active
tags: [cca, "cheat-sheet", agentic, mcp, "claude-code", "prompt-engineering", "context-management"]
keywords: [CCA, cheat sheet, D1, D2, D3, D4, D5, agentic, tools, MCP, CLAUDE.md, prompt engineering, context management, stop_reason, hooks, structured output]
...
```
/memory    → diagnóstica qué reglas están cargadas
/compact   → reduce contexto cuando sesión se llena
--resume   → continúa sesión anterior
fork_session → explora dos enfoques desde el mismo punto
```
...
✅ Retry funciona:
   Error de formato
   Error semántico corregible
   Incluir: documento + output fallido + error específico

❌ Retry inútil:
   Información que no existe en el documento
   Solución: campo nullable
```
...
*(Domain covered in D5 study guide)*
